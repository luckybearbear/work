...
<html>
  ...
  <body>
    <center>
    <div style="width: 450">
    <form action="${pageContext.request.contextPath }/updatecompany.action" method="post" id="form" onsubmit="return checkform()">
    <input type="hidden" name="cid" value="${getOneCompanyByCid.cid}" />
    	<table>
    	
    		<tr>
    			<th>企业名称</th>
    			<td>
    				<input name="cname" type="text" value="${getOneCompanyByCid.cname}" id="cname">
    			</td>
    		</tr>
    		<tr class="space">
    			<td>&nbsp;</td>
    		...
    		<tr>
    			<th>企业帐号</th>
    			<td>
    				<input name="cloginname" type="text" value="${getOneCompanyByCid.cloginname}" id="cloginname">
    			</td>
    		</tr>
    		<tr class="space">
    			<td>&nbsp;</td>
    		...
    		<tr>
    			<th>密码</th>
    			<td>
    				<input name="cloginpwd" type="text" value="${getOneCompanyByCid.cloginpwd}" id="cloginpwd">
    			</td>
    		</tr>
    		<tr class="space">
    			<td>&nbsp;</td>
    		...
    		<tr>
    			<th>联系方式</th>
    			<td>
    				<input name="ccontact" type="text" value="${getOneCompanyByCid.ccontact}" id="ccontact"/>
    			</td>
    		</tr>
    		<tr class="space">
    			<td>&nbsp;</td>
    		...
    		<tr>
    			<th>地址</th>
    			<td>
    				<input name="location" type="text" value="${getOneCompanyByCid.location}" id="location"/>
    			</td>
    		</tr>
    		<tr class="space">
    			<td>&nbsp;</td>
    		...
    		<tr>
    			<th>网址</th>
    			<td>
    				<input name="site" type="text" value="${getOneCompanyByCid.site}" id="site"/>
    			</td>
    		</tr>
    		<tr class="space">
    			<td>&nbsp;</td>
    		...
    		<tr>
    			<th>行业</th>
    			<td>
    				<input name="industry" type="text" value="${getOneCompanyByCid.industry}" id="industry"/>
    			</td>
    		</tr>
    		<tr class="space">
    			<td>&nbsp;</td>
    		...
    		<tr>
    			<th>简介</th>
    			<td>
    				<textarea name="description" id="description">${getOneCompanyByCid.description}</textarea>
    			</td>
    		</tr>
    		<tr class="space">
    			<td>&nbsp;</td>
