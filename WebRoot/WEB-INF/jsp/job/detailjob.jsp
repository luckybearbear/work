  ...
  <body>
    ...
    <input type="hidden" name="jid" value="${detailjob.jid}" />
    	<table>
    		...
    		<tr>
    			<th>薪资</th>
    			<td><input type="text" name="salary" id="salary" value="${detailjob.salary}" readonly="readonly"/></td>
    		</tr>
    		<tr class="space">
    			<td>&nbsp;</td>
    			<td>&nbsp;</td>
    		...
    		<tr>
    			<th>职业介绍</th>
    			<td><textarea rows="4" cols="40" name="jobdescription"  readonly="readonly">${detailjob.jobdescription}</textarea></td>
    		</tr>
    		<tr class="space">
    			<td>&nbsp;</td>
    			<td>&nbsp;</td>
