...
<html>
  ...
  <body>
    <center>
    <div style="width: 450">
    <form action="${pageContext.request.contextPath }/updatestudentbystudent.action" method="post" id="form" onsubmit="return checkform()">
    	<table>
    		...
    		<tr>
    			<th>姓名</th>
    			<td>
    				<input name="stuname" type="text" value="${student.stuname}" id="stuname">
    			</td>
    		</tr>
    		<tr class="space">
    			<td>&nbsp;</td>
    		...
    		<tr>
    			<th>就业状态</th>
    				...
    				<c:choose>
			             <c:when test="${student.emplstatus== '就业'}">
			             	<td>
    		...
    		<tr>
    			<th>密码</th>
    			<td>
    				<input name="stuloginpwd" type="text" value="${student.stuloginpwd}" id="stuloginpwd"/>
    			</td>
    		</tr>
    		<tr class="space">
    			<td>&nbsp;</td>
    		...
    		<tr>
    			<th>邮箱</th>
    			<td>
    				<input name="email" type="text" value="${student.email}" id="email"/>
    			</td>
    		</tr>
    		<tr class="space">
    			<td>&nbsp;</td>
